...
// Simulate the updated katakanaToRomaji function with the new logic
        ...
        res.on('end', () => {
            ...
            if (json.results) {
                json.results.forEach(r => {
                    console.log('Kana1 (Pref):', r.kana1, '->', katakanaToRomaji(r.kana1));
                    console.log('Kana2 (City):', r.kana2, '->', katakanaToRomaji(r.kana2));
                    console.log('Kana3 (Town):', r.kana3, '->', katakanaToRomaji(r.kana3));
                });
            } else {
...
fetchZip('4700111'); // Nisshin (Aichi)
