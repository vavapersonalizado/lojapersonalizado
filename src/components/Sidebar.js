                            ...
                            <>
                                ...
                                <Link
                                    ...
                                    style={{
                                        ...
                                        padding: '0.5rem',
                                        borderRadius: 'var(--radius)',
                                        background: pathname === '/admin/products' ? 'var(--primary)' : 'transparent',
                                        color: pathname === '/admin/products' ? 'var(--primary-foreground)' : 'inherit',
                                        textDecoration: 'none',
                                        fontSize: '0.9rem',
                                        marginBottom: '0.5rem'
                                    }}
                                ...
                                <Link
                                    ...
                                    style={{
                                        ...
                                        padding: '0.5rem',
                                        borderRadius: 'var(--radius)',
                                        background: pathname === '/admin/galeria' ? 'var(--primary)' : 'transparent',
                                        color: pathname === '/admin/galeria' ? 'var(--primary-foreground)' : 'inherit',
                                        textDecoration: 'none',
                                        fontSize: '0.9rem',
                                        marginBottom: '0.5rem'
                                    }}
                                ...
                                <Link
                                    ...
                                    style={{
                                        ...
                                        padding: '0.5rem',
                                        borderRadius: 'var(--radius)',
                                        background: pathname === '/admin/settings' ? 'var(--primary)' : 'transparent',
                                        color: pathname === '/admin/settings' ? 'var(--primary-foreground)' : 'inherit',
                                        textDecoration: 'none',
                                        fontSize: '0.9rem',
                                        marginBottom: '0.5rem'
                                    }}
