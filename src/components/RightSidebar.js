...
export default function RightSidebar() {
    ...
    const toggleGlobalSetting = async (key, currentValue) => {
        ...
        // Optimistic update
        if (key === 'showEvents') setShowEvents(!currentValue);
    ...
    // Render logic update for Events section
    // If not admin and showEvents is false, don't render the section
    if (!isAdmin && !showEvents) {
        // We need to handle this check inside the return or before
    }
